...
Gem::Specification.new do |s|
  ...
  s.files         = [
    ...
    "lib/wolffia/app/cli/services.rb",
    ...
    "lib/wolffia/concurrent/factory.rb",
    "lib/wolffia/concurrent/registry.rb",
    ...
    "lib/wolffia/http.rb",
    "lib/wolffia/http/accept_entry.rb",
    ...
    "lib/wolffia/http/request/utils.rb",
    "lib/wolffia/http/request/utils/accept_parser.rb",
    "lib/wolffia/http/request/utils/headers_parser.rb",
